...
LlmConfig LlmConfig::Make() {
    ...
    LlmConfig config;
    config.btree_grammar_path = root / "data/grammars/btree_pixel.gbnf";
    ...
    config.mmproj_path = root / "data/models/mmproj-Qwen3VL-8B-Instruct-F16.gguf"; // qwen3-vl-8b-instruct.BF16-mmproj.gguf
    config.model_path = root / "data/models/Qwen3VL-8B-Instruct-Q4_K_M.gguf"; // qwen3-vl-8b-instruct.Q4_K_M.gguf
